...
export const translations = {
  en: {
    ...
    'station.liveStatus': 'Live station status',
    'station.arrivals': 'Arrivals',
    'station.departures': 'Departures',
    'station.atPlatform': 'At platform',
    'station.nextArrival': 'Next arrival',
    'station.nextDeparture': 'Next departure',
    'station.seeMyConnections': 'See my connections',
    'station.heroLead': 'Arriving here? Pick your train and RailSense will show what you can catch.',
    'station.arrivingHere': "I'm arriving here",
    'station.whatCanICatch': 'What can I catch next?',
    'station.arrivingLead': 'Choose the service you are arriving on at {station}. Every departure below is then measured against your predicted arrival, not the booked one.',
    'station.imArrivingOn': "I'm arriving on",
    'station.chooseArriving': 'Choose your train\u2026',
    'station.youArrive': 'You arrive',
    'station.bestOption': 'Best option: {train} to {destination} at {time}, giving you {minutes} minutes to change.',
    'station.canCatch': 'You can catch',
    'station.alreadyGone': 'Already gone by the time you arrive',
    'station.nothingCatchable': 'Nothing leaves here in a useful window after you arrive.',
    'station.choosePrompt': 'Choose the train you are arriving on to see what you can catch.',
    'station.toChange': 'to change',
    'station.departsBefore': 'Departs before you arrive',
    'station.arrivingSoon': 'Arriving soon',
    'station.departingSoon': 'Departing soon',
    'station.from': 'From',
    'station.to': 'To',
    'station.catchFrom': 'What can I catch from {station}?',
    'station.catchLead': 'Departures grouped by where they are going. Select a service for its full record.',
    'station.connectivity': 'Station connectivity',
    'station.connectivityLead': 'The routes and stations {station} connects to. Select a station to open it.',
    'station.directConnections': 'Direct connections',
    ...
    'connect.title': 'Will I catch my next train?',
    'connect.lead': 'Tell RailSense which train you are on and which one you need to catch. We use the live predicted arrival, so the transfer time updates on its own as your train runs.',
    'connect.step1': 'My train',
    'connect.step2': 'Change at',
    'connect.step3': 'Connecting train',
    'connect.choose': 'Choose a service…',
    'connect.chooseFirst': 'Pick your train first',
    'connect.noneHere': 'No onward services within the next four hours from this station.',
    'connect.verdictOk': 'You should catch {train}. You will have about {minutes} minutes to change.',
    'connect.verdictRisk': 'This is tight — only {minutes} minutes to change, and you usually need about {min}.',
    'connect.verdictMissed': 'You are likely to miss {train} by about {minutes} minutes if your train keeps running as it is.',
    'connect.arrives': 'arrives',
    'connect.booked': 'booked',
    'connect.departs': 'departs',
    'connect.altSame': 'Next best option',
    'connect.altOnward': 'Next usable trains onward',
    'connect.wait': 'wait',
    'connect.into': 'into',
    'connect.empty': 'Choose where you change and which train you need to catch.',
    ...
    'detail.whereIsIt': 'Where is my train?',
    'detail.inShort': 'In short',
    'detail.doneOf': 'of',
    'detail.imTravelling': "I'm travelling",
    'detail.imTravellingLead': 'Changing trains? Check whether you will make your connection.',
    'detail.nextStop': 'Next stop',
    ...
    'detail.rightNow': 'Right now',
    'detail.causeNote': 'Simulated propagation · the demo engine models running time, not named incidents',
    'detail.scheduledArrival': 'Scheduled arrival',
    'detail.expectedDelay': 'Expected delay on arrival',
    'detail.etaExplanation': 'RailSense expects this service to stay about {minutes} minutes behind schedule into {station}, based on how it is running now and what the sections ahead usually cost.',
    'detail.arrivesIn': 'Arrives in',
    'detail.moreDetail': 'More detail',
    'detail.journeyDetails': 'Journey details',
    'detail.stDeparted': 'Departed',
    'detail.stHere': 'Here now',
    'detail.stNext': 'Next',
    'detail.stUpcoming': 'Upcoming',
    'detail.colScheduled': 'Scheduled',
    'detail.colPredicted': 'Predicted',
  ...
  hi: {
    ...
    'station.liveStatus': 'लाइव स्टेशन स्थिति',
    'station.arrivals': 'आगमन',
    'station.departures': 'प्रस्थान',
    'station.atPlatform': 'प्लेटफ़ॉर्म पर',
    'station.nextArrival': 'अगला आगमन',
    'station.nextDeparture': 'अगला प्रस्थान',
    'station.seeMyConnections': 'मेरे कनेक्शन देखें',
    'station.heroLead': 'यहाँ पहुँच रहे हैं? अपनी ट्रेन चुनें और देखें क्या पकड़ सकते हैं।',
    'station.arrivingHere': 'मैं यहाँ पहुँच रहा हूँ',
    'station.whatCanICatch': 'आगे क्या पकड़ सकता हूँ?',
    'station.arrivingLead': '{station} पर आप जिस ट्रेन से पहुँच रहे हैं, वह चुनें। नीचे हर प्रस्थान आपके अनुमानित आगमन से मापा जाएगा।',
    'station.imArrivingOn': 'मैं आ रहा हूँ',
    'station.chooseArriving': 'अपनी ट्रेन चुनें…',
    'station.youArrive': 'आप पहुँचेंगे',
    'station.bestOption': 'सबसे अच्छा विकल्प: {train}, {destination} के लिए {time} पर — {minutes} मिनट का समय।',
    'station.canCatch': 'आप पकड़ सकते हैं',
    'station.alreadyGone': 'आपके पहुँचने से पहले जा चुकी',
    'station.nothingCatchable': 'आपके पहुँचने के बाद उपयोगी समय में कुछ नहीं जाता।',
    'station.choosePrompt': 'देखने के लिए अपनी ट्रेन चुनें।',
    'station.toChange': 'बदलने को',
    'station.departsBefore': 'आपके पहुँचने से पहले चली जाएगी',
    'station.arrivingSoon': 'जल्द आ रही',
    'station.departingSoon': 'जल्द जा रही',
    'station.from': 'से',
    'station.to': 'के लिए',
    'station.catchFrom': '{station} से क्या पकड़ सकते हैं?',
    'station.catchLead': 'गंतव्य के अनुसार प्रस्थान।',
    'station.connectivity': 'स्टेशन कनेक्टिविटी',
    'station.connectivityLead': '{station} जिन मार्गों और स्टेशनों से जुड़ा है।',
    'station.directConnections': 'सीधे संपर्क',
    'station.services': 'सेवाएँ',
    ...
    'connect.noneHere': 'इस स्टेशन से अगले चार घंटे में कोई आगे की सेवा नहीं।',
    ...
    'detail.whereIsIt': 'मेरी ट्रेन कहाँ है?',
    'detail.inShort': 'संक्षेप में',
    'detail.doneOf': 'में से',
    'detail.imTravelling': 'मैं यात्रा में हूँ',
    'detail.imTravellingLead': 'ट्रेन बदलनी है? जाँचें कि आप कनेक्शन पकड़ पाएँगे या नहीं।',
    'detail.nextStop': 'अगला ठहराव',
    'detail.expected': 'अनुमानित',
    'detail.inTime': 'में',
    'detail.atStation': 'यहाँ:',
    ...
    'detail.rightNow': 'इस समय',
    'detail.causeNote': 'सिमुलेटेड गणना · डेमो इंजन समय का मॉडल रखता है',
    'detail.scheduledArrival': 'निर्धारित आगमन',
    'detail.expectedDelay': 'आगमन पर अनुमानित विलंब',
    'detail.etaExplanation': 'RailSense का अनुमान है कि यह सेवा {station} तक लगभग {minutes} मिनट पीछे रहेगी।',
    'detail.arrivesIn': 'पहुँचने में',
    'detail.moreDetail': 'और जानकारी',
    'detail.journeyDetails': 'यात्रा विवरण',
    'detail.stDeparted': 'रवाना',
    'detail.stHere': 'यहाँ',
    'detail.stNext': 'अगला',
    'detail.stUpcoming': 'आगे',
    'detail.colScheduled': 'निर्धारित',
    'detail.colPredicted': 'अनुमानित',
    'detail.colStatus': 'स्थिति',
